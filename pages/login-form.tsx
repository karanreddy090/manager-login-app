...
export default function LoginForm({ isLoggedin, setIsLoggedin }:{isLoggedin:boolean, setIsLoggedin: React.Dispatch<React.SetStateAction<boolean>>}) {
  ...
  return (
    <div className="container">
      <a href="https://rcadmin1.auth.us-west-2.amazoncognito.com/login?client_id=63040hgvklso6cfdotcd651jah&response_type=token&scope=aws.cognito.signin.user.admin+email+openid+phone+profile&redirect_uri=http://localhost:3000/">Sign in</a>
